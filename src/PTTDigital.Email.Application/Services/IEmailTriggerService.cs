...
namespace PTTDigital.Email.Application.Services
{
    public interface IEmailTriggerService
    {
        ...
        void SendMail(string from, string display, string subject, string body, bool isHtml, IList<Attachment>? attachments, IList<MailAddress> toAddresses, IList<MailAddress> ccAddresses);
    }
}
