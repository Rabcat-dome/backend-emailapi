...
namespace PTTDigital.Email.Common.EncryptDecrypt.Cryptography.RSAx
{
    ...
    /// </summary>
    internal class RSAxParameters : IDisposable
    {
        ...
        private HashAlgorithm ha = SHA256.Create();
        ...
        public byte[] ComputeHash(byte[] data)
        {
            ...
            Rfc2898DeriveBytes pbkdf2 = new Rfc2898DeriveBytes(data, salt, Pbkdf2Helper.ITERATIONS);
            var p455w0rdBytes = pbkdf2.GetBytes(Pbkdf2Helper.HASH_SIZE64);
            return p455w0rdBytes;
