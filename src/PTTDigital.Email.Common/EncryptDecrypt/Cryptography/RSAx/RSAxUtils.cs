...
using PTTDigital.Email.Common.EncryptDecrypt.Helper;

namespace PTTDigital.Email.Common.EncryptDecrypt.Cryptography.RSAx
{
    /// <summary>
    /// Utility class for RSAx
    /// </summary>
    internal class RSAxUtils
    {
        /// <summary>
        ...
        public static RSAxParameters GetRSAxParameters(string XMLKeyInfo, int ModulusSize)
        {
            ...
            try
            {
                ...
                Modulus = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "Modulus"));
                Exponent = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "Exponent"));
            ...
            try
            {
                ...
                //Exponent = Convert.FromBase64String(doc.DocumentElement.SelectSingleNode("Exponent").InnerText);
                Modulus = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "Modulus"));
                D = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "Exponent"));
                Exponent = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "D"));
            ...
            try
            {
                ...
                Modulus = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "Modulus"));
                P = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "P"));
                Q = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "Q"));
                DP = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "DP"));
                DQ = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "DQ"));
                InverseQ = Convert.FromBase64String(XreadFile.takexfile(XMLKeyInfo, "InverseQ"));
                Has_CRT_Info = true;
            }
            catch { }
            ...
            throw new System.Exception("Could not process XMLKeyInfo. Incomplete key information.");
